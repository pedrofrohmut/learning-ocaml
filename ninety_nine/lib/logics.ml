...
let eval_bool_expr (symbol1 : string) (value1: bool) (symbol2: string) (value2 : bool) (expr: bool_expr) : bool =
...
let truth_table (a : string) (b : string) (expr : bool_expr) : (bool * bool * bool) list =
  let res1 = eval_bool_expr a true b true expr in
  let res2 = eval_bool_expr a true b false expr in
  let res3 = eval_bool_expr a false b true expr in
  let res4 = eval_bool_expr a false b false expr in
